...
<title>Performance Benchmarking Samples</title>
<link rel="icon" href="img/favicon.ico">
<script>window['adrum-start-time'] = new Date().getTime();</script><script src="/devops-payments-web/js/adrum.js"></script>
			...
			.ready(
					function() {
						...
						$(".prettyprint").each(function() {
							if ($(this).html().trim() != '') {
								console.log("pretty print: " + $(this).html().trim());
								
								try {
									/**
									var json = JSON.parse($(this).html().trim());
									var str = JSON.stringify(json, null,2);
									var highlights = JSON.parse(str);
...
<body>
	...
	<div class="row header">
		<div class="col-md-5 pull-left">
			<br /> <a href="/java-benchmark/index.html"><h1 class="home">&#10094;&#10094;
